...
exports.ResizeDroplet = function(info, callback) {
  https.get(domain + 'droplets/' + info.droplet + '/resize/?size_id=' + info.size + '&client_id=' + this.clientKey + '&api_key=' + this.apiKey, function(res) {
    res.on('data', function(data) {
      callback(data);
    });
  });
...
exports.DestroyDroplet = function(info, callback) {
  https.get(domain + 'droplets/' + info.droplet + '/destroy/?client_id=' + this.clientKey + '&api_key=' + this.apiKey, function(res) {
    res.on('data', function(data) {
      callback(data);
    });
  });
...
exports.DestroyImage = function(info, callback) {
  https.get(domain + 'images' + info.image + '/destroy/?client_id=' + this.clientKey + '&api_key=' + this.apiKey, function(res) {
    res.on('data', function(data) {
      callback(data);
    });
  });
